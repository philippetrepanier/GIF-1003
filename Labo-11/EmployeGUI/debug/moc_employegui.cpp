...
const QMetaObjectExtraData EmployeGUI::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject EmployeGUI::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_EmployeGUI,
      qt_meta_data_EmployeGUI, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &EmployeGUI::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EmployeGUI))
        return static_cast<void*>(const_cast< EmployeGUI*>(this));
